...
The Vaadin components are distributed as npm packages. Please note that the distributed code is ES2017 and works
out of the box in any modern browser supporting ES modules, including latest Chrome, Safari, Firefox and Edge.
...
- The component with the Lumo theme:
  ...
  `theme/lumo/vaadin-element.js`

- The component with the Material theme:

  `theme/material/vaadin-element.js`

- Alias for `theme/lumo/vaadin-element.js`:
...
1. You can also open demo by adding **demo** to the URL:

  - http://127.0.0.1:3000/components/@vaadin/vaadin-element/demo/
